...
const HeroSection = () => {
  ...
  const [demoHovered, setDemoHovered] = useState(false); // ✅ Added missing state
      ...
      <div className="text-center z-10 px-6">
        ...
        >
          <h1 className="text-6xl md:text-9xl font-black mb-6 tracking-tight">
            ...
            <br />
            <span className="text-7xl">Without Limits</span>
          </h1>

          <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Unleash your creativity with Snaplit, the AI-powered image generation tool that transforms
            your ideas into stunning visuals in seconds. Whether you're a designer, marketer, or
            hobbyist, Snaplit makes it easy to bring your vision to life.
          </p>
          ...
          <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-6 transform-gpu">
            <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 min-h-96">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-gray-400 text-sm">Snaplit</div>
              </div>
